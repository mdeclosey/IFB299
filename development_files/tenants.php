...
if (isset($_GET['save'])) {
	if (isset($_POST['id']) && $_POST['id'] > 0) {
		...
		$update = mysqli_query($db, "UPDATE tenants SET username='{$_POST['username']}', password='{$_POST['password']}', fname='{$_POST['fname']}', lname='{$_POST['lname']}', phone='{$_POST['phone']}', email='{$_POST['email']}' WHERE tenantID='{$_POST['id']}'");
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body" style="padding: 2em">
				<div class="form-group row">
				  ...
				  <div class="col-10">
					<input class="form-control" type="text" value="<?php echo "{$tenant['username']}"; ?>" id="username" name="username">
				  </div>
				</div>
				<div class="form-group row">
